...
const UpComingEvents = () => {
  return (
    <div id="UpComingEvents" className='mt-32 mb-16 lg:w-11/12 px-5 lg:px-0 xl:w-9/12 mx-auto'>
      ...
      <div className='border border-[#999] p-8 rounded-lg'>
        <div className='grid lg:grid-cols-4 items-center  gap-5  mb-8'>
          <div className='flex  md:items-center flex-col md:flex-row  md:gap-10 gap-5 col-span-4 lg:col-span-3  '>
            ...
            <div>
              <h3 className='text-24px font-[600] xl:mb-3 mb-1 '>Eid ul - Adha</h3>
              ...
              <p className='text-[#999] text-[16px]'>In Bangladesh, Eid ul-Adha is a public holiday, commemorating the test of faith passed by Ibrahim according to the Koran.</p>
            </div>
          </div>
          <div className=' col-span-4 lg:col-span-1 '>
            <Image style={{ objectFit: "contain" }} width={1000} height={1000} alt='' src={EidulAzha} />
          </div>
        </div>
        <div className='grid lg:grid-cols-4 items-center  gap-5  mb-8'>
          <div className='flex  md:items-center flex-col md:flex-row  md:gap-10 gap-5 col-span-4 lg:col-span-3  '>
          ...
          <div className=' col-span-4 lg:col-span-1 '>
            <Image style={{ objectFit: "contain" }} width={1000} height={1000} alt='' src={Ashura} />
          </div>
        </div>
        <div className='grid lg:grid-cols-4 items-center  gap-5  mb-8'>
          <div className='flex  md:items-center flex-col md:flex-row  md:gap-10 gap-5 col-span-4 lg:col-span-3  '>
            ...
            <div>
              <h3 className='text-24px font-[600] xl:mb-3 mb-1 '>Eid-Mila-dunnobi</h3>
              <div className='flex items-center flex-wrap gap-5 xl:mb-3 mb-1'>
                <div className='flex items-center gap-3 '>
                  <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 25" fill="none">
                    <path d="M22 12.5C22 18.02 17.52 22.5 12 22.5C6.48 22.5 2 18.02 2 12.5C2 6.98 6.48 2.5 12 2.5C17.52 2.5 22 6.98 22 12.5Z" stroke="#222222" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          ...
          <div className=' col-span-4 lg:col-span-1 '>
            <Image style={{ objectFit: "contain" }} width={1000} height={1000} alt='' src={EidMiladunnobi} />
          </div>
        </div>
        <div className='grid lg:grid-cols-4 items-center  gap-5  mb-8'>
          <div className='flex  md:items-center flex-col md:flex-row  md:gap-10 gap-5 col-span-4 lg:col-span-3  '>
          ...
          <div className=' col-span-4 lg:col-span-1 '>
            <Image style={{ objectFit: "contain" }} width={1000} height={1000} alt='' src={VictoryPic} />
          </div>
        </div>
