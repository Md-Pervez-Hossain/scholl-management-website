      ...
      <div className='border-2 border-[#999] rounded-md p-8'>
        <div className='grid grid-cols-4 gap-10 mb-8 '>
          ...
          <div className='col-span-1'>
            <Image sizes="(max-width: 768px) 100vw, 33vw" alt='' src={EidulAzha} />
          </div>
        </div>
        ...
        <div className='grid grid-cols-4 gap-10  mb-8'>
          <div className='flex items-center gap-10  col-span-3 divide-x-2'>
            <div>
              <h2 className='text-[60px] font-[600] text-[#FFBF64]'>29</h2>
              <p className='text-[#999] text-[18px]'>July</p>
            </div>
            <div className='px-10'>
          ...
          <div className='col-span-1'>
            <Image sizes="(max-width: 768px) 100vw, 33vw" alt='' src={Ashura} />
          </div>
        </div>
        ...
        <div className='grid grid-cols-4 gap-10  mb-8'>
          ...
          <div className='col-span-1'>
            <Image sizes="(max-width: 768px) 100vw, 33vw" alt='' src={EidMiladunnobi} />
          </div>
        </div>
        <div className='grid grid-cols-4 gap-10 '>
          <div className='flex items-center gap-10  col-span-3 divide-x-2'>
            ...
            <div className='px-10'>
              <h3 className='text-24px font-[600] mb-3 '>Victory</h3>
              <div className='flex items-center gap-5'>
                <div className='flex items-center gap-3 mb-3'>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                    <path d="M22 12.5C22 18.02 17.52 22.5 12 22.5C6.48 22.5 2 18.02 2 12.5C2 6.98 6.48 2.5 12 2.5C17.52 2.5 22 6.98 22 12.5Z" stroke="#222222" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
          ...
          <div className='col-span-1'>
            <Image sizes="(max-width: 768px) 100vw, 33vw" alt='' src={VictoryPic} />
          </div>
        </div>
