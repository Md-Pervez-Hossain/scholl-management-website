    ...
    <div className='md:w-9/12 px-5 md:px-0 mx-auto my-16'>
      ...
      <div className='grid md:grid-cols-3 gap-5'>
        <div className='relative'>
          <Image sizes="(max-width: 768px) 100vw, 33vw" alt='' src={AdmissionInfo} />
        ...
        <div className='relative'>
          <Image sizes="(max-width: 768px) 100vw, 33vw" alt='' src={AcademicInfo} />
          <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white'>
        ...
        <div className='relative'>
          <Image sizes="(max-width: 768px) 100vw, 33vw" alt='' src={Rules} />
          <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white'>
