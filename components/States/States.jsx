...
const States = () => {
  ...
  return (
    <>
      <ScrollTrigger onEnter={() => setCounterStage(true)} onExit={() => setCounterStage(false)}>
          ...
          <div className='w-11/12 mx-auto grid grid-cols-2 lg:grid-cols-4 gap-10'>
            ...
            <div className=' flex flex-col items-center justify-center text-center  text-white'>
              ...
              <div>
                <h2 className='text-[32px] font-[400] '>
                  {
                    counterStage && <CountUp duration={2} start={0} end={1500} />
            ...
            <div className=' flex flex-col items-center justify-center text-center  text-white'>
              ...
              <div>
                <h2 className='text-[32px] font-[400] '> {
                  counterStage && <CountUp duration={2} start={0} end={2019} />
                }  </h2>
