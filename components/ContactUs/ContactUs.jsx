  ...
  return (
    <div className='md:w-9/12 px-5 md:px-0 mx-auto my-16'>
      ...
      <div className='grid  xl:grid-cols-3 gap-5'>
        <div className='hover:bg-[#40282C] hover:text-white transition-all duration-700 ease-in-out cursor-pointer border border-[#999] rounded-md p-8  text-center'>
          <div className='mb-3 flex items-center justify-center hiver:text-white'> <svg xmlns="http://www.w3.org/2000/svg" width="101" height="100" viewBox="0 0 101 100" fill="none">
            ...
            <path d="M70.1299 38.54L39.2099 69.46C33.1899 68.08 30.6699 63.92 30.6699 56V44C30.6699 34 34.6699 30 44.6699 30H56.6699C64.5899 30 68.7499 32.52 70.1299 38.54Z" stroke="#A65132" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M67.43 66.76C65.17 69 61.67 70 56.67 70H44.67C42.59 70 40.79 69.82 39.21 69.46L54.67 54L67.43 66.76Z" stroke="#A65132" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" />
